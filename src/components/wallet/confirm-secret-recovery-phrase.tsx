    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div>
        <button
          ...
          className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 m-2 "
        >
          confirm
        </button>
      </div>
