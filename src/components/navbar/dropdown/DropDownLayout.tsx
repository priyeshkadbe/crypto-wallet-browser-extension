...
const DropDownLayout: React.FC<DropDownLayoutProps> = ({
  ...
  return (
    <div className="fixed px-2 top-0 left-0 right-0 bottom-0 z-50   flex justify-center items-center bg-gray-600 bg-opacity-50 ">
      <div className="relative w-full md:w-96 md:transform md:-translate-y-36  bg-[#242526] rounded-lg shadow">
